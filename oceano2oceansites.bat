...
pwd
oceano2oceansites -c %DRIVE%\%CRUISE%\data-processing\%CONFIG% -r %DRIVE%\%CRUISE%\local\code_roscop.csv -d --files=%DRIVE%\%CRUISE%\data-processing\CTD\data\cnv\%PREFIX%*.cnv 
